            ...
            <div class="container">
                ...
                foreach ($service as $s) :
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item" style="width 500px; height:600px;">
                            <div class="service">
                                <img src="<?= base_url('assets/gambar/service/'.$s['gambar']);?>" alt="Image" style="width:250px; height:300px;">
                            </div>
                            ...
                            <a> <?=anchor('home/add_to_cart/'.$s['id_service'], 'pesan' , [
